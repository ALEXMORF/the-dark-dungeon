...
All the game code and render code is coded by hand with only a one library. The render code is written without any external libraries, but the asset loading does use external libraries, since it's a bit tricky.
